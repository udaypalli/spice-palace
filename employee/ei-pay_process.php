...
<body>
    ...
    <div class="payment-form">
        ...
        <form action="ei-pay_redirect.php" method="POST" onsubmit="return validateForm();">
            ...
            <div class="form-group" id="cashFields" style="display: none;">
                ...
                <input type="text" id="cash_amount" name="cash_amount" placeholder="Enter cash amount">
            </div>
        ...
        <script>
            ...
            function validateCashAmount() {
                ...
                if (isNaN(cashAmount) || parseFloat(cashAmount) <= 0) {
